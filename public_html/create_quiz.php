<?php
    ...
    if(isset($_POST['save']))
    {
		...
		<div id="tablecontainer"  style="width:90%;margin-left:auto;margin-right:auto;margin-top:20px;border:1px solid gray">
				<div class="only-text">
				...
				<div class="only-text">
                  ...
                  echo "<table cellpadding='8'>
      						...
      						<td class='blue'> $result_code </td></tr>
      						<tr><td align='right'> Quiz Code : </td>
      						<td class='blue'> $quiz_code</td></tr>
      						</table>";
                       ?>
      					 </p>
      				</article>
...
<html>
	...
	<div id="allcontainer">
		...
		<div id="tablecontainer"  style="width:90%;margin-left:auto;margin-right:auto;margin-top:20px;display:flex">
			<div class="inner-left">
				<div class="inner-left-top">
					
			<form  method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" >

			<label for="Question" style="margin-top:5px" >Question : </label>
			<input style="margin-left:20px;margin-top:5px" type="text" id="question" name="question" required="question"></textarea><br>

			<label for="Right ans" style="margin-top:5px">Right Ans : </label>
			<input style="margin-left:18px;margin-top:5px" type="text" id="right_ans" name="right_ans" required="right_ans"/><br>

			<label for="wrong1" style="margin-top:5px">Wrong Ans1 : </label>
			<input type="text" style="margin-top:5px" id="wrong1" name="wrong1" required="wrong1"/><br>
			<label for="wrong2" style="margin-top:5px">Wrong Ans2 : </label>
			<input type="text"  style="margin-top:5px" id="wrong2" name="wrong2" required="wrong2"/><br>
			<label for="wrong3" style="margin-top:5px">Wrong Ans3 : </label>
			<input type="text" style="margin-top:5px" id="wrong3" name="wrong3" required="wrong3"/><br>
